/**
 * This is an inlined and slightly modified version of
 * https://github.com/visionmedia/mocha-cloud-grid-view/.
 *
 * The reason is that the development on mocha-cloud-grid-view stalled and
 * a very important bugfix was never included (https://github.com/visionmedia/mocha-cloud-grid-view/pull/2)
 *
 * This file will likely morph into something more suited to the new API in the future.
 * 
 * Original Copyright 2012 by visionmedia
 */
...
GridView.prototype.draw = function(ctx){
	...
	this.browsers.forEach(function(browser){
		...
		var pad = new Array(max - label.length).join(' ');
